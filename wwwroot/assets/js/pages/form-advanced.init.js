! function (n) {
    ...
    e.prototype.init = function () {
        ...
        }), n("#colorpicker-default").spectrum(), n("#colorpicker-showalpha").spectrum({
            showAlpha: !0
        ...
        }), n("#colorpicker-showintial").spectrum({
            showInitial: !0
        ...
        n('[data-toggle="touchspin"]').each(function (e, a) {
            ...
            buttondown_class: "btn btn-primary",
            buttonup_class: "btn btn-primary"
        }), n("input[name='demo_vertical']").TouchSpin({
            verticalbuttons: !0
        ...
        i.on({
            ...
            switch (n) {
                case "container":
                    ...
                    break;
                case "trigger":
                    o ? (o = l).prop("disabled", !1) : l.prop("disabled", !0);
                    break;
                case "inline":
                    (a = $('input[name="container"]')).prop("checked") || a.click();
                    break;
                case "language":
                    $('input[name="format"]').val($.fn.datepicker.languages[o].format)
            }
            r[n] = o, i.datepicker("reset").datepicker("destroy").datepicker(r)
